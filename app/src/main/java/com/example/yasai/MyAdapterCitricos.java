...
public class MyAdapterCitricos extends RecyclerView.Adapter<MyAdapterCitricos.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<Datos> lista;
    ArrayList<Datos> lista_full;
    static String filter;
    public MyAdapterCitricos(Context con, ArrayList<Datos> lista){
        this.con=con;
        this.lista=lista;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyAdapterCitricos.MyViewHolder(V);
    }
