...
public class MyAdapterPlato extends RecyclerView.Adapter<MyAdapterPlato.MyViewHolder> implements Filterable {

    Context con;
    ArrayList<Datos> lista;
    ArrayList<Datos> lista_full;
    static String filter5;
    public MyAdapterPlato(Context con, ArrayList<Datos> lista){
        this.con=con;
        this.lista=lista;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyAdapterPlato.MyViewHolder(V);
    }
    ...
    private Filter example_filter1=new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0){
                ...
                filter5=constraint.toString().toLowerCase().trim();
                for (Datos item:lista_full){
                    if (item.getNom().toLowerCase().contains(filter5)){
