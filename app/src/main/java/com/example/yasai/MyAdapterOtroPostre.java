...
public class MyAdapterOtroPostre  extends RecyclerView.Adapter<MyAdapterOtroPostre.MyViewHolder> implements Filterable {

    Context con;
    ArrayList<Datos> lista;
    ArrayList<Datos> lista_full;
    static String filter;
    public MyAdapterOtroPostre(Context con, ArrayList<Datos> lista){
        this.con=con;
        this.lista=lista;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyAdapterOtroPostre.MyViewHolder(V);
    }
