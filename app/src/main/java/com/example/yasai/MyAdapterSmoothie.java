...
public class MyAdapterSmoothie extends RecyclerView.Adapter<MyAdapterSmoothie.MyViewHolder> implements Filterable {
    Context con;
    ArrayList<Datos> lista;
    ArrayList<Datos> lista_full;
    static String filter8;
    public MyAdapterSmoothie(Context con, ArrayList<Datos> lista){
        this.con=con;
        this.lista=lista;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new MyAdapterSmoothie.MyViewHolder(V);
    }
        ...
        holder.agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(holder.cantidad.getText().toString().equals("")){
                    ...
                    Datos objeto_comprado=new Datos(nombre,precio,holder.cantidad.getText().toString(),null);
    ...
    private Filter example_filter1=new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0){
                ...
                filter8=constraint.toString().toLowerCase().trim();
                for (Datos item:lista_full){
                    if (item.getNom().toLowerCase().contains(filter8)){
